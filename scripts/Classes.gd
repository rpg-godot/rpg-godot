class character:
	...
	var pic = ["res://assets/textures/profiles/friendlies/tex_anime_ava_28.png", true, false]
	var picBorder = [true, "res://assets/textures/profiles/image_border.png"]
	var attacks = []
	var level = 1
	var skills = []
	var APmax = 1
...
static func DeathHound(attacks:Array, level:int, skills:Array, APmax:int, APspeed:int, healthMax:int):
	...
	Character.pic = ["res://assets/textures/profiles/enemies/monsters_avatar_icons_61.png", false, false]
...
var attackImages = {
	"Fists":"res://assets/images/icons/fists_attack.png",
	"Sword":"res://assets/images/icons/sword_attack.png"
	}
