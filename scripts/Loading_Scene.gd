...
func _ready():
	...
	var Player = Classes.CreateClass("Ally", [8,8,8,8,8,8,8], ["res://assets/textures/profiles/friendlies/tex_anime_ava_01.png", true, false], [true, "res://assets/textures/profiles/image_border.png"], [[1, 4], [1], []], 1, [0], 1, 0.5, 100, 100)
