...
func _on_Complete_pressed():
	...
	for stat in get_node("MainMenu/Choices/Stats/Display/Menu/IAL").get_children():
		stats.append(int(stat.get_node("Numbers/Number").text))
	print (stats)
	var Player = Classes.CreateCharacter(get_node("MainMenu/Choices/CharacterName/Name").text, stats, [Profiles[selectedCharacter], true, false], [true, "res://Assets/Images/Profiles/ImageBorder.png"], [[1, 4], [1], []], 1, [0], 1, 0.5, 100, 100)
