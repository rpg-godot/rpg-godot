...
func _ready():
	...
	for save in saves:
			...
			var picture = save.get("picture", Characters.new().characters.alrune.picture)
			if typeof(meta) != TYPE_DICTIONARY:
				picture = Characters.characters.alrune.picture
			var player = save
...
func _on_button_press(save: Dictionary):
	...
	Core.emit_signal("msg", "Button pressed!", Log.DEBUG, self)
...
func _on_play_pressed():
	Core.emit_signal("msg", "Play pressed!", Log.DEBUG, self)
